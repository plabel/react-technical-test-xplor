...
export default function Mentioned({ actor: user, created_at, source }: MentionedProps) {
  ...
  return (
    <Stack direction="row" spacing={2}>
      ...
      <Box>
        ...
        <Box>
          <Chip
            startDecorator={sourceState === "closed" ? <CheckCircleOutlineIcon /> : <AdjustIcon />}
            color={sourceState === "closed" ? "warning" : "success"}
          >
            {sourceState}
          </Chip>
